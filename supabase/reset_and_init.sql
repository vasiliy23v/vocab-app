...
-- Also seeds a one-time "starter" deck (8 basic words) for every
-- brand-new user — just something to click through, not a curriculum.
-- Fully the student's own deck: they can edit or delete it like any other.
